...
CONST_MRS_WATSON = "\"" + "/Users/andres/Documents/Duke/acoustics/project/dx7-programmer/MrsWatson-0.9.8/Mac OS X/mrswatson" + "\""
...
def get_mrs_watson_command(mrswatson, vsti, midifile, params, outfile):
	...
	print(cmd) # debugging, let's see what this does
	return cmd
...
# what happens when I just call this entire thing
"""
## Status:
* calling this file, I get a random sound with a short duration. This is fun, but
we need something a little more directional....
